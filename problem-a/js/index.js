...
let numberRatio = (( updatedMotto.length / motto.length ) * 100 ).toFixed(2);
console.log(numberRatio + "%");
...
//11 numbers in the function, median chooses the 6th element
let median = sortedArray[5];
console.log(median);
...
let circle = {
    cx:34,
    cy:43,
    radius: sortedArray[sortedArray.length - 1]};
console.log(circle);
